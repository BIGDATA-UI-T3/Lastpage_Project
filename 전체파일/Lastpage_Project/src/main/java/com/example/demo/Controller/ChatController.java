...
import com.example.demo.Domain.Common.Service.ChatSessionService;
import com.example.demo.support.VectorSearchService;
import com.example.demo.support.VectorSearchService.Document;
...
public class ChatController {
    ...
    */
    public ChatController(ChatModel chatModel, ChatSessionService sessionService,
                          ...
                          @Value("${chatbot.api-base-url:http://54.116.21.71:8090}") String apiBaseUrl) {
