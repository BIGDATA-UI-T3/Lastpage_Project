...
CREATE TABLE IF NOT EXISTS `funeralDB`.`TBL_QnA` (
  `QnA_id` INT NOT NULL,
  `FAQ` VARCHAR(45) NULL,
  `question-updated_at` VARCHAR(45) NULL,
  `question-created_at` VARCHAR(45) NULL,
  `question_is_deleted` VARCHAR(45) NULL,
  `answer-created_at` VARCHAR(45) NULL,
  `answer_is_deleted` VARCHAR(45) NULL,
  `answer-updated_at` VARCHAR(45) NULL,
  PRIMARY KEY (`QnA_id`))
ENGINE = InnoDB;
